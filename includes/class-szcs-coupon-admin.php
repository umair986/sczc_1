...
class SzCsCouponAdmin
{
  ...
  public function admin_scripts()
  {
    ...
    if (in_array($screen_id, array('szcs_coupons_code', 'edit-szcs_coupons_code', 'coupons_page_szcs-coupon-generator', 'edit-product_cat', 'edit-product_brand', 'product', 'coupons_page_szcs-coupon-export', 'toplevel_page_szcs-coupon-export', 'edit-product'), true)) {
